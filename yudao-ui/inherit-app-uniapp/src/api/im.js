...
export const recallPrivateMessage = (id) => adminDelete('/im/message/private/recall', { id })

// ---------- 群聊 ----------
export const sendGroupMessage = (data) => adminPost('/im/message/group/send', data)
...
export const recallGroupMessage = (id) => adminDelete('/im/message/group/recall', { id })

// ---------- 会话已读位置 ----------
export const pullConversationReadList = (limit, lastId, lastUpdateTime) =>
  adminGet('/im/conversation-read/pull', { limit, lastId, lastUpdateTime })

// ---------- 好友 ----------
export const getFriendList = () => adminGet('/im/friend/list')
export const deleteFriend = (friendUserId, clear) =>
  adminDelete('/im/friend/delete', { friendUserId, clear })

// ---------- 好友申请 ----------
export const applyFriendRequest = (data) => adminPost('/im/friend-request/apply', data)
export const agreeFriendRequest = (id) => adminPut('/im/friend-request/agree', { id })
...
// ---------- 群组 ----------
export const getGroupList = () => adminGet('/im/group/list')
export const getGroup = (id) => adminGet('/im/group/get', { id })
export const createGroup = (data) => adminPost('/im/group/create', data)
export const quitGroup = (groupId) => adminDelete('/im/group/quit', { groupId })
export const dissolveGroup = (id) => adminDelete('/im/group/dissolve', { id })
export const getGroupMemberList = (groupId) => adminGet('/im/group-member/list', { groupId })
export const inviteGroupMember = (groupId, memberUserIds) =>
  adminPost('/im/group/invite', { groupId, memberUserIds })

// ---------- 群申请 ----------
export const applyJoinGroup = (groupId, applyContent) =>
  adminPost('/im/group-request/apply', { groupId, applyContent })
      ...
      success: (res) => {
        try {
          ...
          if (body && body.code === 0) {
            ...
            reject(body || { code: -1, msg: '上传失败' })
          }
        } catch (e) {
          reject({ code: -1, msg: '上传响应解析失败' })
        }
      },
      fail: () => reject({ code: -1, msg: '上传失败' }),
    })
  })
}
