            ...
            try {
                ...
                for (StackTraceElement stackTrace : stackTraces) {
                    if (ObjUtil.notEqual(stackTrace.getClassName(), ServiceExceptionUtil.class.getName())) {
                        log.warn("[serviceExceptionHandler] code={}, message={}, method={}, uri={}, queryParameterNames={}, source={}",
                                ex.getCode(), ex.getMessage(), request.getMethod(), request.getRequestURI(),
                                request.getParameterMap().keySet(), stackTrace);
                        break;
                    }
                }
